# -*- coding: utf-8 -*-
#
# python-stix documentation build configuration file, created by
...
man_pages = [
    ('index', 'python-stix', u'python-stix Documentation',
...
texinfo_documents = [
  ('index', 'python-stix', u'python-stix Documentation',
   u'The MITRE Corporation', 'python-stix', 'One line description of project.',
   'Miscellaneous'),
]
