...
#
# Generated Thu Apr 11 15:06:28 2013 by generateDS.py version 2.9a.
#
...
def parse(inFileName):
    ...
    if rootClass is None:
        rootTag = 'PackageIntentVocab-1.0'
        rootClass = PackageIntentVocab_1_0
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="PackageIntentVocab-1.0",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from stix_default_vocabularies import *\n\n')
    sys.stdout.write('from datetime import datetime as datetime_\n\n')
    sys.stdout.write('import stix_default_vocabularies as model_\n\n')
