...
#
# Generated Thu Apr 11 15:08:18 2013 by generateDS.py version 2.9a.
#
...
class VariablesType(GeneratedsSuper):
    ...
    variable elements. Each variable element holds the value of an
    external variable used in an OVAL Definition. Please refer to
    the description of the VariableType for more information about
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='oval-var:', name_='VariablesType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='oval-var:', name_='VariablesType'):
        pass
    def exportChildren(self, outfile, level, namespace_='oval-var:', name_='VariablesType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class VariableType(GeneratedsSuper):
    """Each variable element contains the associated datatype and value
    which will be substituted into the OVAL Definition that is
    referencing this specific variable.Note that the 'record'
    datatype is not permitted on variables."""
    subclass = None
    superclass = None
    def __init__(self, datatype=None, comment=None, id=None, value=None):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='oval-var:', name_='VariableType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='oval-var:', name_='VariableType'):
    ...
    def exportChildren(self, outfile, level, namespace_='oval-var:', name_='VariableType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        for value_ in self.value:
            value_.export(outfile, level, '', name_='value', pretty_print=pretty_print)
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for value_ in self.value:
            showIndent(outfile, level)
            outfile.write('model_.xsd_anySimpleType(\n')
            value_.exportLiteral(outfile, level, name_='xsd:anySimpleType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'value':
            obj_ = xsd_anySimpleType.factory()
            obj_.build(child_)
...
def parse(inFileName):
    ...
    if rootClass is None:
        rootTag = 'oval_variables'
        rootClass = oval_variables
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="oval_variables",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from oval-variables-schema import *\n\n')
    sys.stdout.write('from datetime import datetime as datetime_\n\n')
    sys.stdout.write('import oval-variables-schema as model_\n\n')
