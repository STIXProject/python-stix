...
class SimpleLiteral(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='SimpleLiteral', fromsubclass_=False, pretty_print=True):
        ...
        if self.anytypeobjs_ is not None:
            self.anytypeobjs_.export(outfile, level, '', pretty_print=pretty_print)
...
class elementContainer(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='', name_='elementContainer', fromsubclass_=False, pretty_print=True):
        ...
        for any_ in self.get_any():
            any_.export(outfile, level, '', name_='any', pretty_print=pretty_print)
...
def parse(inFileName):
    ...
    if rootClass is None:
        rootTag = 'SimpleLiteral'
        rootClass = SimpleLiteral
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="SimpleLiteral",
        namespacedef_='')
    return rootObj
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from dc import *\n\n')
    sys.stdout.write('from datetime import datetime as datetime_\n\n')
    sys.stdout.write('import dc as model_\n\n')
