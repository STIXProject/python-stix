...
class localizedString(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cvrf-common:', name_='localizedString', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportAttributes(self, outfile, level, already_processed, namespace_='cvrf-common:', name_='localizedString'):
    ...
    def exportChildren(self, outfile, level, namespace_='cvrf-common:', name_='localizedString', fromsubclass_=False, pretty_print=True):
        pass
...
class localizedNormalizedString(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='cvrf-common:', name_='localizedNormalizedString', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='cvrf-common:', name_='localizedNormalizedString'):
        if self.lang is not None and 'lang' not in already_processed:
            already_processed.add('lang')
            outfile.write(' lang=%s' % (self.gds_format_string(quote_attrib(self.lang).encode(ExternalEncoding), input_name='lang'), ))
    def exportChildren(self, outfile, level, namespace_='cvrf-common:', name_='localizedNormalizedString', fromsubclass_=False, pretty_print=True):
        pass
...
def parse(inFileName):
    ...
    if rootClass is None:
        rootTag = 'localizedString'
        rootClass = localizedString
...
def parseString(inString):
    ...
    doc = None
    sys.stdout.write('<?xml version="1.0" ?>\n')
    rootObj.export(sys.stdout, 0, name_="localizedString",
        namespacedef_='')
    return rootObj
