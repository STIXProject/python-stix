...
class YaraTestMechanismType(indicator.TestMechanismType):
    """The YaraTestMechanismType specifies an instantial extension from the
    abstract indicator.TestMechanismType intended to support the inclusion of
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='yaraTM:', name_='YaraTestMechanismType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='yaraTM:', name_='YaraTestMechanismType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Version is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sVersion>%s</%sVersion>%s' % ('yaraTM:', self.gds_format_string(quote_xml(self.Version).encode(ExternalEncoding), input_name='Version'), 'yaraTM:', eol_))
        if self.Rule is not None:
            self.Rule.export(outfile, level, 'yaraTM:', name_='Rule', pretty_print=pretty_print)
    def exportLiteral(self, outfile, level, name_='YaraTestMechanismType'):
        level += 1
        already_processed = set()
    ...
    def exportLiteralAttributes(self, outfile, level, already_processed, name_):
        super(YaraTestMechanismType, self).exportLiteralAttributes(outfile, level, already_processed, name_)
    def exportLiteralChildren(self, outfile, level, name_):
        super(YaraTestMechanismType, self).exportLiteralChildren(outfile, level, name_)
        if self.Version is not None:
            showIndent(outfile, level)
            outfile.write('Version=%s,\n' % quote_python(self.Version).encode(ExternalEncoding))
        if self.Rule is not None:
            outfile.write('Rule=model_.stix_common.EncodedCDATAType(\n')
...
GDSClassesMapping = {
    ...
    'Rule': stix_common.EncodedCDATAType,
...
def parseLiteral(inFileName):
    ...
    # Enable Python to collect the space used by the DOM.
    doc = None
    sys.stdout.write('#from yara import *\n\n')
    sys.stdout.write('from datetime import datetime as datetime_\n\n')
    sys.stdout.write('import yara as model_\n\n')
