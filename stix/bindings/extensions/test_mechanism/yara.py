...
class YaraTestMechanismType(indicator_binding.TestMechanismType):
    ...
    def exportChildren(self, outfile, level, nsmap, namespace_=XML_NS, name_='YaraTestMechanismType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Version is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%s:Version>%s</%s:Version>%s' % (nsmap[namespace_], self.gds_format_string(quote_xml(self.Version).encode(ExternalEncoding), input_name='Version'), 'yaraTM:', eol_))
