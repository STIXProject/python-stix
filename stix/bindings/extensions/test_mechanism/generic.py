...
class GenericTestMechanismType(indicator_binding.TestMechanismType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='genericTM:', name_='GenericTestMechanismType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
    ...
    def exportChildren(self, outfile, level, namespace_='genericTM:', name_='GenericTestMechanismType', fromsubclass_=False, pretty_print=True):
        ...
        if self.Description is not None:
            self.Description.export(outfile, level, 'genericTM:', name_='Description', pretty_print=pretty_print)
        if self.Type is not None:
            self.Type.export(outfile, level, 'genericTM:', name_='Type', pretty_print=pretty_print)
        if self.Specification is not None:
            self.Specification.export(outfile, level, 'genericTM:', name_='Specification', pretty_print=pretty_print)
