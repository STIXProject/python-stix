...
#
# Generated Tue Nov 06 14:03:18 2012 by generateDS.py version 2.7c.
#
...
class RoutesType(GeneratedsSuper):
    ...
    def exportLiteralChildren(self, outfile, level, name_):
        ...
        for Route_ in self.Route:
            ...
            Route_.exportLiteral(outfile, level, name_='network_route_entry_object_1_1.NetworkRouteEntryObjectType')
            showIndent(outfile, level)
            outfile.write('),\n')
        level -= 1
        showIndent(outfile, level)
