...
#
# Generated Tue Nov 06 14:04:31 2012 by generateDS.py version 2.7c.
#
...
class WindowsPrivilegeType(user_account_object_1_2.PrivilegeType):
...
class WindowsGroupType(user_account_object_1_2.GroupType):
...
class WindowsUserAccountObjectType(user_account_object_1_2.UserAccountObjectType):
    ...
    def __init__(self, object_reference=None, disabled=None, locked_out=None, Description=None, Domain=None, password_required=None, Full_Name=None, Group_List=None, Home_Directory=None, Last_Login=None, Privilege_List=None, Script_Path=None, Username=None, User_Password_Age=None, Security_ID=None, Security_Type=None):
        super(WindowsUserAccountObjectType, self).__init__(object_reference, disabled, locked_out, Description, Domain, password_required, Full_Name, Group_List, Home_Directory, Last_Login, Privilege_List, Script_Path, Username, User_Password_Age, )
