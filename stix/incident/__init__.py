...
class Incident(stix.BaseCoreComponent):
    ...
    status = VocabField("Status", vocabs.IncidentStatus)
    ...
    discovery_methods = VocabField("Discovery_Method", vocabs.DiscoveryMethod, multiple=True, key_name="discovery_methods")
    ...
    security_compromise = VocabField("Security_Compromise", vocabs.SecurityCompromise)
