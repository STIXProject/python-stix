...
import stix
from stix.common.vocabs import ImpactRating, SecurityCompromise
...
class IndirectImpactSummary(stix.Entity):
    ...
    def loss_of_competitive_advantage(self, value):
        ...
        elif isinstance(value, SecurityCompromise):
    ...
    def from_obj(cls, obj, return_obj=None):
        ...
        return_obj.loss_of_competitive_advantage = SecurityCompromise.from_obj(obj.get_Loss_Of_Competitive_Advantage())
        return_obj.brand_and_market_damage = SecurityCompromise.from_obj(obj.get_Brand_And_Market_Damage())
        return_obj.increased_operating_costs = SecurityCompromise.from_obj(obj.get_Increased_Operating_Costs())
        return_obj.legal_and_regulatory_costs = SecurityCompromise.from_obj(obj.get_Legal_And_Regulatory_Costs())
        return return_obj
    ...
    def from_dict(cls, dict_, return_obj=None):
        ...
        return_obj.loss_of_competitive_advantage = SecurityCompromise.from_dict(dict_.get('loss_of_competitive_advantage'))
        return_obj.brand_and_market_damage = SecurityCompromise.from_dict(dict_.get('brand_and_market_damage'))
        return_obj.increased_operating_costs = SecurityCompromise.from_dict(dict_.get('increased_operating_costs'))
        return_obj.legal_and_regulatory_costs = SecurityCompromise.from_dict(dict_.get('legal_and_regulatory_costs'))
